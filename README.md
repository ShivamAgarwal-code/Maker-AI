...
### Installation
In terminal, clone the repository: `git clone git@github.com/ShivamAgarwal-code/Maker-AI.git`
...
1. In terminal, go to smartcontract folder: `cd maker-ai/src/smartcontract`
...
#### AI-Agent (Backend)
1. In terminal, go to ai-agent folder: `cd maker-ai/src/ai-agent/`
2. Create .env
- The PRIVATE_KEY is the private key of **AI AGENT** wallet
- The MILESTONE_MAKER_ADDRESS is the contract address from step #6 of deploy smart contract section
- PINATA_API_KEY, PINATA_SECRET_API_KEY are used to store the data on IPFS. You can register to Pinata and get the free key.
...
#### Frontend
1. In terminal, go to frontend folder: `cd maker-ai/src/frontend`
2. Create .env
- The NEXT_PUBLIC_CONTRACT_ADDRESS is the contract address from step #6 of deploy smart contract section
```
NEXT_PUBLIC_CONTRACT_ADDRESS=
...
## Demonstration
You can check this clip [Youtube](https://youtu.be/cxyl7XEeNEM)
or
